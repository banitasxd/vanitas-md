...
let developerName = 'V A N I T A S'
...
alfa.ev.on('messages.upsert', async chatUpdate => {
	...
	for (let i of kon) {
	    list.push({
	    	...
	    	item3.URL:https://www.instagram.com/vanitasx_d/\n
	    	item3.X-ABLabel:Instagram\n
	    	item4.URL:https://github.com/banitasxd/\n
	    	item4.X-ABLabel:GitHub\n
	    	END:VCARD`
})
	}
	alfa.sendMessage(jid, { contacts: { displayName: `V A N I T A S`, contacts: list }, ...opts }, { quoted })
    }
